package shop.liaozalie.zjt.gb28181.event;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.context.ApplicationEventPublisher;
import org.springframework.stereotype.Component;
import shop.liaozalie.zjt.gb28181.bean.DeviceAlarm;
import shop.liaozalie.zjt.gb28181.bean.DeviceChannel;
import shop.liaozalie.zjt.gb28181.bean.GbStream;
import shop.liaozalie.zjt.gb28181.bean.RecordInfo;
import shop.liaozalie.zjt.gb28181.event.alarm.AlarmEvent;
import shop.liaozalie.zjt.gb28181.event.device.RequestTimeoutEvent;
import shop.liaozalie.zjt.gb28181.event.platformKeepaliveExpire.PlatformKeepaliveExpireEvent;
import shop.liaozalie.zjt.gb28181.event.platformNotRegister.PlatformCycleRegisterEvent;
import shop.liaozalie.zjt.gb28181.event.platformNotRegister.PlatformNotRegisterEvent;
import shop.liaozalie.zjt.gb28181.event.record.RecordEndEvent;
import shop.liaozalie.zjt.gb28181.event.subscribe.catalog.CatalogEvent;
import shop.liaozalie.zjt.media.zlm.event.ZLMOfflineEvent;
import shop.liaozalie.zjt.media.zlm.event.ZLMOnlineEvent;
