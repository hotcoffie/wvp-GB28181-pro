package shop.liaozalie.zjt.gb28181.transmit.event.request.impl.message.notify.cmd;
...
import shop.liaozalie.zjt.gb28181.transmit.event.request.impl.message.notify.NotifyMessageHandler;
import shop.liaozalie.zjt.gb28181.utils.NumericUtil;
import shop.liaozalie.zjt.gb28181.utils.XmlUtil;
import shop.liaozalie.zjt.service.IDeviceAlarmService;
...
public class AlarmNotifyMessageHandler extends SIPRequestProcessorParent implements InitializingBean, IMessageHandler {
    ...
    public void handForDevice(RequestEvent evt, Device device, Element rootElement) {
        ...
        String alarmDescription = XmlUtil.getText(rootElement, "AlarmDescription");
        ...
        if (!StringUtils.isEmpty(deviceAlarm.getDeviceId())) {
            if (deviceAlarm.getAlarmMethod().contains(DeviceAlarmMethod.Video.getVal() + "")) {
                deviceAlarm.setAlarmType(XmlUtil.getText(rootElement.element("Info"), "AlarmType"));
            }
        }
