package shop.liaozalie.zjt.gb28181.transmit.event.request.impl.message.control.cmd;

import shop.liaozalie.zjt.VManageBootstrap;
...
import shop.liaozalie.zjt.gb28181.transmit.event.request.impl.message.control.ControlMessageHandler;
import shop.liaozalie.zjt.storager.IVideoManagerStorage;
import shop.liaozalie.zjt.utils.SpringBeanFactory;
...
public class DeviceControlQueryMessageHandler extends SIPRequestProcessorParent implements InitializingBean, IMessageHandler {
    ...
    public void handForPlatform(RequestEvent evt, ParentPlatform parentPlatform, Element rootElement) {
        ...
        // 云台/前端控制命令
        if (!StringUtils.isEmpty(XmlUtil.getText(rootElement,"PTZCmd")) && !parentPlatform.getServerGBId().equals(targetGBId)) {
